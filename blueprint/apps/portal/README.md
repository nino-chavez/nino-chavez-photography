...
The stamper handles project name, repo URL, tagline, package scope, `--nino-*` CSS prefix, and logo substitution. Post-stamp mechanical check fails on any unexpected residual `nino-chavez-photography` strings.
...
3. **Run the substrate tooling** if your initiative actually uses Hive — see `$BLUEPRINT_HOME/docs/hive-coordination-pattern.md`.
