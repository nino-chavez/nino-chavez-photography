...
Shared React component library for the nino-chavez-photography family. Patterns adapted from BigCommerce's `storefront-kit` (React + Tailwind + Radix + CVA), tuned for our portfolio: portal, prototype, storefront-catalyst, subscriber portal, admin.
