...
<div
	class={cn(
		'group px-6 py-4 rounded-lg bg-charcoal-900 border border-charcoal-800 hover:border-charcoal-700 hover:scale-[1.02] transition-transform transition-colors',
		className
	)}
>
