...
>
	...
	{#if coverImageUrl}
		<div class="absolute inset-0">
			...
			<div class="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent group-hover:from-black/95 group-hover:via-black/60 transition-all duration-300"></div>
		</div>
	{:else}
		<!-- Fallback gradient -->
	...
	<div class="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
		<div class="absolute inset-0 bg-gradient-to-tr from-transparent via-gold-500/10 to-transparent transform translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-700 ease-out"></div>
	</div>
	...
	<div class="absolute inset-x-0 bottom-0 p-6 transform transition-transform duration-300 ease-out group-hover:-translate-y-2">
		<!-- Photo Count -->
		<div class="flex items-center gap-2 mb-3">
			<div class="flex items-center gap-1.5 px-2.5 py-1 bg-charcoal-900/80 backdrop-blur-sm rounded-full border border-charcoal-700/50 group-hover:border-gold-500/50 transition-colors duration-200">
		...
		<Typography
			variant="h3"
			class="text-xl font-bold text-white mb-2 group-hover:text-gold-400 transition-colors duration-200 line-clamp-2"
		>
			{collection.title}
		</Typography>
		...
		<div class="overflow-hidden max-h-0 group-hover:max-h-24 transition-all duration-300 ease-out">
			<Typography
				variant="body"
				class="text-sm text-charcoal-300 italic line-clamp-2 mb-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-75"
			>
		...
		<Typography
			variant="body"
			class="text-xs text-charcoal-400 line-clamp-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100"
		>
	...
	<!-- Border Glow Effect -->
	<div class="absolute inset-0 rounded-xl border border-gold-500/0 group-hover:border-gold-500/20 transition-all duration-300 pointer-events-none"></div>
</a>
